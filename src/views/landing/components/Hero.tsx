        ...
        <Row>
          <Col lg={8} className="mx-auto text-center">
            ...
            <div className="avatar-group avatar-group-sm justify-content-center mt-2 d-flex gap-1">
              {users.map((user, idx) => (
                <div className="avatar" key={idx}>
                  <img src={user} alt={`User-${idx}`} className="avatar-sm rounded-circle" />
                </div>
              ))}
            </div>
            ...
            <div className="d-flex gap-2 flex-wrap justify-content-center">
              <Link to="/" className="btn btn-secondary py-2 fw-semibold d-flex align-items-center">
        ...
        <Container className="position-relative">
          <Row>
            <Col md={10} className="mx-auto position-relative">
              ...
              <img src={dashboardImg} className="rounded-top-4 shadow-lg img-fluid mt-5" alt="SaaS Dashboard" />
            </Col>
          </Row>
        </Container>
      </Container>
