      ...
      <div className="container">
        <div className="row align-items-center pb-5">
          <div className="col-lg-6 col-xl-5 py-3">
            <div className="position-relative">
              ...
              <img src={chatImg} className="rounded-3 shadow-lg img-fluid mt-5 z-1 position-relative" alt="saas-img" />
          ...
          <div className="col-lg-5 ms-auto py-3">
            ...
            <Link to="/chat" className="btn btn-primary mb-4">
              Check Chat App
            </Link>
        ...
        <div className="row align-items-center py-5">
          <div className="col-lg-5 py-5 order-2 order-lg-1">
            ...
            <Link to="/file-manager" className="btn btn-primary mb-4">
          ...
          <div className="col-lg-6 col-xl-5 ms-auto py-5 order-1 order-lg-2">
            <div className="position-relative">
              ...
              <img src={fileManagerImg} className="rounded-3 shadow-lg img-fluid mt-5 z-1 position-relative" alt="saas-img" />
              <figure className="position-absolute bottom-0 end-0 me-n5 mb-n5 opacity-25">
                <svg width={120} height={120} xmlns="http://www.w3.org/2000/svg">
                  <g fill="#f8ac59">
                    <circle cx={10} cy={10} r={4} />
        ...
        <div className="row align-items-center py-5">
          <div className="col-lg-6 col-xl-5 py-3">
            <div className="position-relative">
              ...
              <img src={teamImg} className="rounded-3 shadow-lg img-fluid mt-5 z-1 position-relative" alt="saas-img" />
              <figure className="position-absolute bottom-0 end-0 me-n5 mb-n5 opacity-25">
                <svg width={120} height={120} xmlns="http://www.w3.org/2000/svg">
                  <g fill="#ed5565">
                    <circle cx={10} cy={10} r={4} />
          ...
          <div className="col-lg-5 ms-auto py-3">
            ...
            <Link to="/contacts" className="btn btn-primary mb-4">
              Check Contacts App
            </Link>
            <div className="d-flex flex-wrap justify-content-between gap-4 mt-4">
